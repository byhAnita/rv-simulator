const en = {
  ...
  cast: {
    ...
    save: "Save member",
    cancel: "Cancel",
    describe: "✨ Describe her in one line",
    describePlaceholder: "a reserved cellist who never sleeps before 3am",
    ...
    fields: {
      ...
      private_personality: "Private personality",
    ...
    pickMainHint: "Tap to cycle: ★ main → ● sub → ○ NPC",
  ...
  settings: {
    ...
    birthYearEstimated: "This save recorded only your age, so the year was estimated and may be off by one — which flips unnie with anyone born the same year. Set it here.",
    birthYearRange: (min, max) => `Enter a year between ${min} and ${max}.`,
    birthYearSaved: "Birth year updated — honorifics follow from the next round.",
